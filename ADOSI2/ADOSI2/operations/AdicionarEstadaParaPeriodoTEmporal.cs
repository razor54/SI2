...
namespace ADOSI2.operations
{
    ...
    {
        public static void AdicionarEstadaParaPeriodoTemporal(Context ctx)
        {
            int id;
            DateTime datainicio;
            DateTime dataFim;
            ...
            var criar = new CriarEstadaParaPeriodoTemporal(ctx);

            criar.Execute(id, datainicio, dataFim, nifHospede, bi, nomeHospede
